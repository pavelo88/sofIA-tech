...
const ContactSection = ({ lang }: ContactSectionProps) => {
  ...
  return (
    <section className="py-12 sm:py-24 relative overflow-hidden border-b border-white/10" id="contact" style={{ background: "#0a0f15" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-10 text-center relative z-10">
        ...
        <p className="font-body text-sm sm:text-base text-white/50 leading-relaxed max-w-xl mx-auto mb-7 border-l border-r border-white/5 px-4">
          {t.desc}
        </p>
